...
import ProjectList from '../components/scenes/project-list'
      ...
      <ConnectedRouter history={history} location={props.location} context={props.context}>
        <StartupConnected>
          <Switch>
            ...
            <Route exact path="/:username" component={() => <ProjectList />} />
            <Route exact path="/:username/:project" component={() => <Project />} />
